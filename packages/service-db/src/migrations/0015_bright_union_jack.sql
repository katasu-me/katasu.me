...
INSERT INTO `__new_image`("id", "user_id", "width", "height", "title", "status", "created_at", "updated_at") SELECT "id", "user_id", "width", "height", "title", "status", "created_at", "updated_at" FROM `image`;--> statement-breakpoint
