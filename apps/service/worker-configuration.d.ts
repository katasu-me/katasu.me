/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 180fa72481b6c5b0ea366cb33b6afc6a)
// Runtime types generated with workerd@1.20251105.0 2025-09-02 global_fetch_strictly_public,nodejs_compat_v2
declare namespace Cloudflare {
  interface Env {
    CACHE_KV: KVNamespace;
    VITE_SITE_URL: string;
    VITE_IMAGE_R2_URL: string;
    VITE_REPORT_IMAGE_TILLY_EMBED_ID: string;
    VITE_REPORT_USER_TILLY_EMBED_ID: string;
    ...
    IMAGE_OPTIMIZER: Fetcher /* katasu-me-image-optimizer-dev */;
  }
}
