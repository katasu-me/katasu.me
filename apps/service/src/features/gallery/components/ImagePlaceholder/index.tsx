...
export default function ImagePlaceholder({ className, ...props }: Props) {
  return (
    <div className={twMerge("relative aspect-[16/9] h-48 w-auto", className)} {...props}>
      <div className="absolute inset-0 flex items-center justify-center rounded-lg border-2 border-warm-black-25 border-dashed bg-warm-black-50/5">
