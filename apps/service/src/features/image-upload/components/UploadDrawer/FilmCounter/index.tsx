...
export default function FilmCounter({ total, max }: Props) {
  ...
  return (
    <div className="flex items-center gap-1 text-sm text-warm-black">
      ...
      <div className="relative overflow-hidden rounded-sm bg-warm-black px-2 py-1 text-warm-white before:pointer-events-none before:absolute before:top-0 before:left-0 before:z-overlay before:h-2 before:w-full before:bg-gradient-to-b before:from-warm-black before:to-transparent after:pointer-events-none after:absolute after:bottom-0 after:left-0 after:h-2 after:w-full after:bg-gradient-to-t after:from-warm-black after:to-transparent">
