  ...
  return (
    <VaulDrawer.Root {...props}>
      ...
      <VaulDrawer.Portal>
        ...
        <VaulDrawer.Content className="fixed right-0 bottom-0 left-0 z-50 m-2 pc:m-4 h-fit overflow-hidden rounded-xl bg-warm-white p-8 pc:px-4 pt-4 outline-none">
          <VaulDrawer.Handle />
