  ...
  return (
    <div className={twMerge("w-full", className)}>
      ...
      <input
        ...
        ref={ref}
        maxLength={maxLength}
        className="w-full rounded-md border border-warm-black-50 px-3 py-2 text-warm-black focus:border-warm-black focus:outline-none disabled:cursor-not-allowed disabled:bg-gray-100"
      />
      {hasBottom && (
