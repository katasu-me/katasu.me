...
export default function TagLink({ name, href, image }: TagLinkProps) {
  return (
    <Link
      className="interactive-scale-brightness relative flex h-8 pc:h-10 shrink-0 items-center justify-center overflow-hidden rounded-md bg-warm-black-50 px-4 py-2 text-center"
      href={href}
    >
